...
app_ui = ui.page_navbar(
    ...
    ui.nav_panel(
        ...
        ui.layout_columns(
            ui.value_box("Mejor modelo según AUC", best_model_name, "Promedio out-of-fold.", theme="teal"),
            ui.value_box(
                "Mejor AUC promedio",
    ...
    ui.nav_panel(
        ...
        ui.layout_sidebar(
            ...
            ui.layout_columns(
                ui.card(
                    ui.card_header("Fila de entrada al modelo"),
                    ui.output_data_frame("input_row_table"),
                    full_screen=True,
                ),
                ui.card(
                    ui.card_header("Validaciones y advertencias"),
                    ui.output_ui("calc_warnings"),
                    full_screen=True,
                ),
                col_widths=(7, 5),
            ),
